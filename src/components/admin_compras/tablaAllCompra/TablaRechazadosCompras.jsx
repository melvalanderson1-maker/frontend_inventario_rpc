...
export default function TablaRechazadosCompras({ filtro = "" }) {
  ...
  const cargar = () => {
    ...
    const estados = "RECHAZADO_LOGISTICA";

    api
      .get("/api/compras/movimientos/todos", { params: { estados } })
      .then((res) => setRows(res.data || []))
      .catch((err) => {
        console.error("❌ Error cargando rechazados compras:", err);
        setRows([]);
      })
  ...
  return (
    <div className="table-wrapper">
      <strong>Rechazados compras</strong>
