...
// ==========================
export default function TablaCambiosAlmacenTodosPendientes({ filtro = "" }) {
  ...
  const cargar = () => {
    api
      .get("/api/logistica/cambios-almacen/todos-pendientes")
            ...
            {rowsFiltrados.length === 0 ? (
              ...
              rowsFiltrados.map((r) => (
                <tr key={r.id}>
                  ...
                  <td className="td-num">{r.cantidad_disponible}</td>
