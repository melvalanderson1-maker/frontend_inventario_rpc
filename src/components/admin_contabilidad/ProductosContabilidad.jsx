// src/components/admin_contabilidad/ProductosContabilidad.jsx
...
import "./ProductosContabilidad.css"; // Puedes copiar el CSS de Logistica y renombrarlo
...
export default function ProductosContabilidad() {
  ...
  // Obtener categorías desde API Contabilidad
  useEffect(() => {
  ...
  // Obtener productos desde API Contabilidad
  useEffect(() => {
    api.get("/api/contabilidad/productos", { params: { search } })
      ...
      <div className="productos-grid">
        {productosFiltrados.map(p => (
          <div key={p.id} className="producto-card">
            ...
            <Link to={`/contabilidad/producto/${p.id}`} className="producto-link">
              Ver detalle →
            </Link>
