...
// ==========================
export default function TablaCambiosAlmacenPendientesContabilidad({ productoId, filtro = "" }) {
  ...
  const cargar = () => {
    api
      .get("/api/contabilidad/cambios-almacen/pendientes")
      .then((res) => {
        let data = res.data || [];
        if (productoId) {
  ...
  const confirmarRechazo = async () => {
    ...
    try {
      await api.post(
        `/api/contabilidad/cambios-almacen/${rechazoSeleccionado.id}/rechazar`,
