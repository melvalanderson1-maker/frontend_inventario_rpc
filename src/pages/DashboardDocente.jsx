  ...
  return (
    <div className="docente-container">
      <header className="docente-header">
        ...
        <p className="subtitle">Bienvenido, aquí puedes gestionar tus clases y actividades.</p>
      </header>
      ...
      <div className="docente-grid">
        ...
        <Link to="/docente/sesiones" className="docente-card">
          ...
          <p>Administra tus sesiones programadas, clases y actividades del curso.</p>
        </Link>
        ...
        <Link to="/docente/asistencia" className="docente-card">
          ...
          <p>Pasa la lista de asistencia a tus estudiantes de forma rápida.</p>
        </Link>
        ...
        <Link to="/docente/notas" className="docente-card">
          ...
          <p>Califica actividades, exámenes y trabajos de tus alumnos.</p>
        </Link>
